...
CREATE TABLE `employees` (
  ...
  `FIO` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ФИО сотрудника',
  `experience` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Стаж работы',
  `number_emp` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Рабочий телефон',
