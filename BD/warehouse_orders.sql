...
CREATE TABLE `orders` (
  ...
  `Code` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Уникальный код заказа',
  ...
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'В обработке' COMMENT 'Статус заказа',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Дополнительная информация',
