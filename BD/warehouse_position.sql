...
CREATE TABLE `position` (
  ...
  `position_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название должности',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Справочник должностей';
